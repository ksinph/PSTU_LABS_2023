# Вариант задания
Реализовать поиски по Кнута - Морриса - Пратта и Бойера - Мура.
# Код программы
```cpp
#include <iostream>
#include <string>
...
# Префикс-функция calcprefixFunc
<image src="calcprefixFunc.drawio.svg">

# Функция KMPSearch
<image src="KMPSearch.drawio.svg">

# Функция calccharTable
<image src="calccharTable.drawio.svg">

# Функция BMSearch
<image src="BMSearch.drawio.svg">
	
# Тесты
### Пример 1
Входные данные:
```
Введите строку в которой будет происхожить поиск
abcabceabcabcd
Введти паттерн который будет искаться
abcd
Введите цифру которая бдует соответствовать поиску которых нужно применить: 1
```
Выходные данные:
```
Паттен найден на позиции 11
```
### Пример 2
Входные данные:
```
...
Введти паттерн который будет искаться
aabc
Введите цифру которая бдует соответствовать поиску которых нужно применить: 2
```
Выходные данные:
```
Паттерн найден на позиции 6
```
### Пример 3
Входные данные:
```
